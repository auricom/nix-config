{
  ...
  pname = "kopia-ui";
  version = "v0.14.1"; # renovate: datasource=github-tags depName=kopia/kopia versioning=semver nix=fetchurl
  ...
  src = pkgs.fetchurl {
    ...
    hash = "fff"; # renovate: datasource=github-tags depName=kopia/kopia
  };
